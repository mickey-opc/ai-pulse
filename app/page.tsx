...
const translations = {
  en: {
    ...
    emailDescription: "Subscribe for new-article email updates every hour while the crawler refreshes the database every day.",
    latestSignal: "Latest signal",
    filterDescription: "Sorted by publish time. Filter by source without leaving the page.",
    allSources: "All sources",
    footerNote: "Cron schedule: fetch every day, email notifications every hour.",
  },
  zh: {
    ...
    activeSources: "活跃来源",
    emailBrief: "邮件简报",
    emailDescription: "订阅每1小时发送的新文章邮件提醒，爬虫每天刷新数据库",
    latestSignal: "最新资讯",
    filterDescription: "按发布时间排序，可按来源筛选",
    allSources: "全部来源",
    footerNote: "爬虫：每天抓取，邮件提醒：每1小时运行一次",
  }
};
